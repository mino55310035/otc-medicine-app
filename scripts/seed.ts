...
const medicines: SeedMedicine[] = [
  // ===== 鎮痛・解熱 =====
  {
    ...
    document_text: '効能・効果：頭痛・月経痛（生理痛）・歯痛・抜歯後の疼痛・咽喉痛・腰痛・関節痛・神経痛・筋肉痛・肩こり痛・耳痛・打撲痛・骨折痛・ねんざ痛・外傷痛の鎮痛、悪寒・発熱時の解熱。用法・用量：成人（15歳以上）1回1錠、1日2回まで。再度症状があらわれた場合には3回目を服用できる。服用間隔は4時間以上おくこと。',
    ingredients: [
      { name: 'ロキソプロフェンナトリウム水和物', amount: '68.1mg（無水物として60mg）' },
    ],
    contraindications: [
      { type: 'banned', condition: '15歳未満の小児', severity: 'high' },
      { type: 'banned', condition: '出産予定日12週以内の妊婦', severity: 'high' },
  ...
  },
  {
    ...
    category: '鎮痛・解熱',
    manufacturer: 'ライオン',
    document_text: '効能・効果：頭痛・歯痛・月経痛（生理痛）・神経痛・腰痛・外傷痛・抜歯後の疼痛・咽喉痛・耳痛・関節痛・筋肉痛・肩こり痛・打撲痛・骨折痛・ねんざ痛の鎮痛、悪寒・発熱時の解熱。用法・用量：成人（15歳以上）1回2錠、1日2回まで。',
    ingredients: [
  ...
  },
  {
    ...
    document_text: '効能・効果：頭痛・月経痛（生理痛）・歯痛・抜歯後の疼痛・咽喉痛・耳痛・関節痛・神経痛・腰痛・筋肉痛・肩こり痛・打撲痛・骨折痛・ねんざ痛・外傷痛の鎮痛、悪寒・発熱時の解熱。用法・用量：成人（15歳以上）1回1錠、1日3回まで。服用間隔は4時間以上おくこと。空腹時は避けること。',
    ingredients: [
  ...
  },
  {
    ...
    category: '鎮痛・解熱',
    manufacturer: 'エスエス製薬',
    document_text: '効能・効果：頭痛・月経痛（生理痛）・歯痛・咽喉痛・関節痛・筋肉痛・神経痛・腰痛・肩こり痛・抜歯後の疼痛・打撲痛・耳痛・骨折痛・ねんざ痛・外傷痛の鎮痛、悪寒・発熱時の解熱。用法・用量：成人（15歳以上）1回2錠、1日3回まで。',
    ingredients: [
  ...
  },
  {
    ...
    category: '鎮痛・解熱',
    manufacturer: '大正製薬',
    document_text: '効能・効果：頭痛・月経痛（生理痛）・歯痛・抜歯後の疼痛・咽喉痛・腰痛・関節痛・神経痛・筋肉痛・肩こり痛・打撲痛・骨折痛・ねんざ痛・外傷痛の鎮痛、悪寒・発熱時の解熱。用法・用量：成人（15歳以上）1回2錠、1日2回まで。',
    ingredients: [
  ...
  // ===== 風邪薬 =====
  {
    ...
    category: '風邪薬',
    manufacturer: '大正製薬',
    document_text: '効能・効果：かぜの諸症状（鼻水、鼻づまり、くしゃみ、のどの痛み、せき、たん、悪寒、発熱、頭痛、関節の痛み、筋肉の痛み）の緩和。用法・用量：成人（15歳以上）1回3錠、1日3回食後なるべく30分以内に服用。',
    ingredients: [
  ...
  },
  {
    ...
    category: '風邪薬',
    manufacturer: '第一三共ヘルスケア',
    document_text: '効能・効果：かぜの諸症状（のどの痛み、発熱、鼻水、鼻づまり、くしゃみ、せき、たん、悪寒、頭痛、関節の痛み、筋肉の痛み）の緩和。用法・用量：成人（15歳以上）1回2錠、1日3回食後なるべく30分以内に服用。',
    ingredients: [
  ...
  },
  {
    ...
    document_text: '効能・効果：かぜの諸症状（発熱、頭痛、のどの痛み、関節の痛み、筋肉の痛み、せき、鼻水、鼻づまり、くしゃみ、たん、悪寒）の緩和。用法・用量：成人（15歳以上）1回2カプレット、1日3回食後なるべく30分以内に服用。',
    ingredients: [
      { name: 'イブプロフェン', amount: '450mg' },
  ...
  },
  {
    ...
    document_text: '効能・効果：かぜの諸症状（鼻水、鼻づまり、くしゃみ、のどの痛み、せき、たん、悪寒、発熱、頭痛、関節の痛み、筋肉の痛み）の緩和。用法・用量：成人（15歳以上）1回2カプセル、1日2回朝夕食後に服用。',
    ingredients: [
  ...
  },
  {
    ...
    category: '風邪薬',
    manufacturer: 'クラシエ',
    document_text: '効能・効果：体力中等度以上のものの次の諸症：感冒の初期（汗をかいていないもの）、鼻かぜ、鼻炎、頭痛、肩こり、筋肉痛、手や肩の痛み。用法・用量：成人（15歳以上）1回1包、1日3回食前または食間に服用。',
    ingredients: [
      { name: '葛根湯エキス（カッコン・マオウ・タイソウ・ケイヒ・シャクヤク・カンゾウ・ショウキョウ）', amount: '3200mg' },
    ],
    contraindications: [
      { type: 'caution', condition: '高血圧', severity: 'medium' },
      { type: 'caution', condition: '心臓病', severity: 'medium' },
  ...
  // ===== 胃腸薬 =====
  {
    ...
    category: '胃腸薬',
    manufacturer: '第一三共ヘルスケア',
    document_text: '効能・効果：胃痛、もたれ、胸やけ、むかつきに。H2ブロッカー薬。胃酸の出過ぎをコントロールし、胃粘膜の修復を助ける。用法・用量：成人（15歳以上80歳未満）1回1錠、1日2回まで。',
    ingredients: [
      { name: 'ファモチジン', amount: '10mg' },
    ],
    contraindications: [
      { type: 'banned', condition: '15歳未満の小児', severity: 'high' },
  ...
  },
  {
    ...
    category: '胃腸薬',
    manufacturer: '太田胃散',
    document_text: '効能・効果：飲みすぎ、胸やけ、胃部不快感、胃弱、胃もたれ、食べすぎ、胃痛、消化不良、消化促進、食欲不振、胃酸過多、胃部・腹部膨満感、はきけ、嘔吐、胸つかえ、げっぷ。用法・用量：成人（15歳以上）1回1.3g（添付のサジ1杯）、1日3回食後または食間に服用。',
    ingredients: [
  ...
  },
  {
    ...
    category: '胃腸薬',
    manufacturer: '大幸薬品',
    document_text: '効能・効果：軟便、下痢、食あたり、水あたり、はき下し、くだり腹、消化不良による下痢、むし歯痛。用法・用量：成人（15歳以上）1回3粒、1日3回食後に服用。',
    ingredients: [
  ...
  },
  {
    ...
    document_text: '効能・効果：整腸（便通を整える）、軟便、便秘、腹部膨満感。用法・用量：成人（15歳以上）1回3錠、1日3回食後に服用。5歳以上15歳未満は1回2錠。',
    ingredients: [
  ...
  },
  {
    ...
    category: '胃腸薬',
    manufacturer: 'エーザイ',
    document_text: '効能・効果：胃痛、胃酸過多、胸やけ、胃部不快感、胃部膨満感、もたれ、胃重、げっぷ、はきけ。用法・用量：成人（15歳以上）1回1包、1日3回食間または就寝前に服用。',
    ingredients: [
  ...
  // ===== 鼻炎薬 =====
  {
    ...
    category: '鼻炎薬',
    manufacturer: '久光製薬',
    document_text: '効能・効果：花粉、ハウスダスト（室内塵）などによる次のような鼻のアレルギー症状の緩和：くしゃみ、鼻水、鼻づまり。用法・用量：成人（15歳以上）1回1錠、1日2回朝夕に服用。',
    ingredients: [
      { name: 'フェキソフェナジン塩酸塩', amount: '60mg' },
    ],
    contraindications: [
      { type: 'banned', condition: '15歳未満の小児', severity: 'high' },
      { type: 'caution', condition: '妊娠中', severity: 'medium' },
  ...
  },
  {
    ...
    category: '鼻炎薬',
    manufacturer: 'エスエス製薬',
    document_text: '効能・効果：花粉、ハウスダスト（室内塵）などによる次のような鼻のアレルギー症状の緩和：くしゃみ、鼻水、鼻づまり。用法・用量：成人（15歳以上）1回1錠、1日1回就寝前に服用。',
    ingredients: [
      { name: 'エピナスチン塩酸塩', amount: '20mg' },
    ],
    contraindications: [
      { type: 'banned', condition: '15歳未満の小児', severity: 'high' },
      { type: 'caution', condition: '妊娠中', severity: 'medium' },
  ...
  },
  {
    ...
    category: '鼻炎薬',
    manufacturer: '大正製薬',
    document_text: '効能・効果：急性鼻炎、アレルギー性鼻炎または副鼻腔炎による次の諸症状の緩和：くしゃみ、鼻水（鼻汁過多）、鼻づまり、なみだ目、のどの痛み、頭重（頭が重い）。用法・用量：成人（15歳以上）1回2カプセル、1日2回朝夕食後に服用。',
    ingredients: [
  ...
  // ===== その他 =====
  {
    ...
    category: 'その他',
    manufacturer: '第一三共ヘルスケア',
    document_text: '効能・効果：口内炎（アフタ性）の治療。口内の患部に直接貼って治す口内炎パッチ。用法・用量：1日1～2回、患部に貼付する。',
    ingredients: [
      { name: 'トリアムシノロンアセトニド', amount: '0.025mg' },
    ],
    contraindications: [
      { type: 'caution', condition: '妊娠中', severity: 'medium' },
  ...
  },
  {
    ...
    category: 'その他',
    manufacturer: '武田コンシューマーヘルスケア',
    document_text: '効能・効果：眼精疲労、筋肉痛・関節痛（肩こり、腰痛、五十肩など）、神経痛、手足のしびれの緩和。「つらい」目の疲れ、肩・首すじのこり、腰の痛みに。用法・用量：成人（15歳以上）1回2～3錠、1日1回食後に服用。',
    ingredients: [
      { name: 'フルスルチアミン塩酸塩（ビタミンB1誘導体）', amount: '109.16mg' },
      { name: 'ピリドキシン塩酸塩（ビタミンB6）', amount: '100mg' },
      { name: 'シアノコバラミン（ビタミンB12）', amount: '1500μg' },
      { name: 'トコフェロールコハク酸エステルカルシウム（ビタミンE）', amount: '103.58mg' },
...
async function seed() {
  ...
  for (const med of medicines) {
    ...
    if (med.ingredients.length > 0) {
      ...
      if (ingError) console.error(`  成分エラー (${med.name}): ${ingError.message}`)
    }

    // 禁忌を挿入
    if (med.contraindications.length > 0) {
      const { error: conError } = await supabase.from('contraindications').insert(
      ...
      if (conError) console.error(`  禁忌エラー (${med.name}): ${conError.message}`)
    }
